...
sp1.searchParamCreate('source_port_id', 'string', 'Dalma Airport', SearchParam_1.SearchOperationBuilder.create(true, false, false), isAndOperator);
...
searchParam.push(sp6, sp7, sp8, sp9, sp100);
//        
